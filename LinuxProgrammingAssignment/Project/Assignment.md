...
thay đổi không?, nếu có thay đổi thì cập nhật lại chu kỳ X. Người dùng có thể echo giá trị
chu kỳ X mong muốn vào file “freq.txt” để thread INPUT cập nhật lại X.
...
.
2. Viết shell script để thay đổi lại giá trị chu kỳ X trong file “freq.txt” sau mỗi 1 phút. Các giá
...
4. Thực hiện khảo sát file “time_and_interval.txt”: Vẽ đồ thị giá trị interval đối với mỗi giá
trị chu kỳ X và đánh giá.
Note: Có thể sử dụng cuốn The Linux Programming Interface, by Michael Kerrisk (2010) để tra
cứu. Ví dụ với multithreading có thể tham khảo Chương 29: Thread: Introduction để xem cách tạo
thread. Với đo đạc thời gian có thể tham khảo Chương 23: Timers and Sleeping